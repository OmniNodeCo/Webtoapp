...
export function getCliProgram() {
  ...
  const logo = `${chalk.green(' _       __    __    _                               ')}
${green('| | /| / /__ / /_  | |_ ___  ___ _ ___  ___  ___  ')}
${green('| |/ |/ / -_)  \\ |  _/ _ \\/ _` | / _ \\/ _ \\/ _ \\ ')}
${green('|__/|__/\\___|_\\_\\  \\__\\___/\\__,_|_\\___/\\___/\\___/')}
${yellow('https://github.com/OmniNodeCo/Webtoapp')}
${green('Turn a trusted website into a desktop app.')}
`;
  ...
  return program
    ...
    .option(
      '--config <path>',
      'Load options from a JSON config file (fields mirror CLI options, see schema/webtoapp.schema.json)',
    )
    .addOption(
      new Option(
        '--basic-auth',
    ...
    .addOption(
      new Option(
        ...
        'Keep every link inside the Webtoapp window instead of opening external handlers',
