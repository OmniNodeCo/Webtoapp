...
export function generateMenu(
    ...
    const { webtoappVersion, zoom, disableDevTools } = options;
    ...
    const editMenu: MenuItemConstructorOptions = {
        ...
        submenu: [
            ...
            },
            {
                ...
                // https://github.com/OmniNodeCo/Webtoapp/issues/404
    ...
    const viewMenu: MenuItemConstructorOptions = {
        ...
        submenu: [
            ...
            },
            {
                ...
                accelerator: 'CmdOrCtrl+[', // What old versions of Webtoapp used, kept for backwards compat
                click: goBack,
            },
            {
                label: 'Forward',
    ...
    const helpMenu: MenuItemConstructorOptions = {
        ...
        submenu: [
            {
                label: `Built with Webtoapp v${webtoappVersion}, Electron v${electronVersion}`,
                click: (): void => {
                    openExternal(
                        'https://github.com/OmniNodeCo/Webtoapp',
                    ).catch((err: unknown): void =>
                        log.error(
                            'Built with Webtoapp v${webtoappVersion}.click ERROR',
                            err,
                        ),
                    );
                },
                ...
                switch (bookmark.type) {
                    case 'link':
                        ...
                        return {
                            ...
                            click: (): void => {
                                goToURL(bookmark.url)?.catch(
                                    (err: unknown): void =>
                                        log.error(
                                            `${bookmark.title}.click ERROR`,
                                            err,
                                        ),
                                );
                            },
                            accelerator:
                                'shortcut' in bookmark
                                    ? bookmark.shortcut
                                    : undefined,
                        };
                    case 'separator':
