...
export default async function handleOptions(
  ...
  // Webtoapp's manual Windows workflow uses Tauri's --no-bundle path to
  // produce a portable raw .exe instead of an MSI installer. macOS retains
  // normal bundle behavior because an .app is the portable desktop format.
