(function () {
  ...
  const PANEL_ID = "webtoapp-find-panel";
  const STYLE_ID = "webtoapp-find-style";
  const MARK_ATTR = "data-webtoapp-find";
  const ACTIVE_ATTR = "data-webtoapp-find-active";
  const MATCH_HIGHLIGHT = "webtoapp-find-match";
  const ACTIVE_HIGHLIGHT = "webtoapp-find-active";
  ...
  function ensureStyle() {
    ...
    style.textContent = `
      ...
      #${PANEL_ID} [data-webtoapp-find-counter] {
        flex: 0 0 auto;
        min-width: 42px;
        color: #5f6b7a;
        text-align: center;
      ...
      #${PANEL_ID} [data-webtoapp-find-status] {
        position: absolute;
        left: 10px;
        top: calc(100% + 4px);
        color: #d1242f;
  ...
  function ensurePanel() {
    ...
    counter.setAttribute("data-webtoapp-find-counter", "");
    ...
    status.setAttribute("data-webtoapp-find-status", "");
