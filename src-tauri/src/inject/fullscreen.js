...
(function () {
  ...
  function initFullscreenPolyfill() {
    ...
    if (!document.getElementById("webtoapp-fullscreen-style")) {
      const styleEl = document.createElement("style");
      styleEl.id = "webtoapp-fullscreen-style";
      styleEl.textContent = `
      body.webtoapp-fullscreen-active {
        overflow: hidden !important;
      }
      .webtoapp-fullscreen-element {
      ...
      .webtoapp-fullscreen-element video {
        width: 100% !important;
    ...
    function enterFullscreen(element) {
      ...
      targetElement.classList.add("webtoapp-fullscreen-element");
      document.body.classList.add("webtoapp-fullscreen-active");
    ...
    function exitFullscreen() {
      ...
      targetElement.classList.remove("webtoapp-fullscreen-element");
      document.body.classList.remove("webtoapp-fullscreen-active");
