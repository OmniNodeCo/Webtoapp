...
describe("event fullscreen shortcuts", () => {
  ...
  it("creates the drag region only for the active platform flag", () => {
    ...
    expect(
      windowsWithMacFlag.document.getElementById("webtoapp-top-dom"),
    ).toBeNull();
    expect(
      windowsWithDecorationsFlag.document.getElementById("webtoapp-top-dom"),
    ).not.toBeNull();
    expect(
      macWithDecorationsFlag.document.getElementById("webtoapp-top-dom"),
    ).toBeNull();
    expect(
      macWithTitleBarFlag.document.getElementById("webtoapp-top-dom"),
    ).not.toBeNull();
  });
});
