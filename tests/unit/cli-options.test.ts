...
import { getCliProgram } from '../../cli/helpers/cli-program.js';
import { validateNumberInput } from '../../cli/utils/validate.js';
...
describe('CLI options', () => {
  ...
  it('rejects malformed zoom values instead of truncating them', () => {
    ...
    // field, so they must be rejected rather than forwarded to webtoapp.json.
